...
**IMPORTANT:** 
1. Only return RAW DATA (facts, prices, weather). Absolutely DO NOT design detailed itineraries.
...
def get_researcher_agent():
    ...
    if _researcher_agent_instance is None:
        ...
        def enhanced_search(query: str) -> str:
            ...
            video_id = "NONE"
            try:
                search_url = "https://www.youtube.com/results?search_query=" + urllib.parse.quote(query + " du lịch review")
...
async def call_researcher(state: dict):
    logger.info("🔍 [Researcher Agent] Retrieving data from document....")
